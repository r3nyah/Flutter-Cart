...
import 'package:food_ordering/common/helpers.dart';
...
class _ProductScreenState extends State<ProductScreen> with TickerProviderStateMixin{
  ...
  void initState(){
    ...
    getAllData = DBHelper.dbHelper.fetchSearchedRecode(data: "Fast Food");
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  onChanged: (val){
                    print("calllesd+________________${val}____________________________");
                    setState(() {
                      DBHelper.dbHelper.fetchSearchedRecode(data: val);
                    });
                  },
                ...
                onTap: (value){
                  setState((){
                    ...
                    if(initialTabIndex2 == 1){
                      getAllData = DBHelper.dbHelper.fetchSearchedRecode(data: "Fruits");
                    }

                    if(initialTabIndex2 == 2){
                      getAllData = DBHelper.dbHelper.fetchSearchedRecode(data: "Grocery");
                    }

                    if(initialTabIndex2 == 3){
                      getAllData = DBHelper.dbHelper.fetchSearchedRecode(data: "Veges");
                    }
                  });
                },
                tabs: [
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Image.asset(data[i].image,height: height * 0.08,),
                                        ...
                                        setState(() {
                                          if(data[i].like == "false"){
                                            ...
                                            Provider.of<CartProvider>(
                                              context,
                                              listen: false
                                            ).RemoveFromFavourite(product: data[i]);
                                          }
                                        });
                                      },
